...
const Discussions = () => {
	return (
		<>
			<h1 className='dashboard-heading mb-6'>Discussions</h1>

			{/* Intro and Create Post Button */}
			<div className="flex flex-col md:flex-row">
				<p className="text-sidebarBlue text-base font-medium bg-white p-4 md:p-8 rounded-md w-full md:mr-9 shadow-md mb-4">
			...
			<DiscussionsContainer className='mt-6' />
		</>
	);
};

...
const DiscussionCard = ({
	...
	return (
		<div className='border-2 border-grey_light hover:border-pink_primary hover:shadow-xl transition-all duration-200 rounded-md p-4'>
			<div className="flex">
				{/* Content */}
				<div className="content">
					<h1 className='text-sidebarBlue font-medium text-sm'>{title}</h1>
					<Space className="mt-2 font-medium text-navBlue text-xs flex items-center">
